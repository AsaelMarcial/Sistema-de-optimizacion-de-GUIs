...
from engine.enums.scope import CSS_PROPERTIES_BY_ID, CSS_PROPERTY_COMPUTED_ALIASES
from engine.rendering.models.snapshot_models import RenderSnapshot, SnapshotNode, SnapshotOptions
...
def normalize_snapshot_nodes(
    ...
    *,
    ...
    metadata = {
        "module": "rendering.rendering_pipeline",
        "basePath": base_path,
